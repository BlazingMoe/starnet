...
The comparison script's final change isolates geometry/cache history; it changes no product code. Syntax and source-text-integrity validation cover it. Post-merge receipt will be appended after integration. No installer build, installed-app verification, push or public release is included.
