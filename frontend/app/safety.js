/* STARNET — safety.js : emergency-stop logic, SYSTEM menu control + Alt+H hotkey.
   ...
   The visible control lives in SYSTEM, alongside the other station controls, and teaches Alt+H.
   The hotkey stays global. */
'use strict';
(function () {
  ...
  if (document.readyState !== 'loading') wireEstop();
  else document.addEventListener('DOMContentLoaded', wireEstop);
})();
