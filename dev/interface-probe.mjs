...
try {
  ...
  await check('Toolset statuses match switch and prop state', `Array.from(document.querySelectorAll('.ts-row')).every(r=>r.querySelector('.ts-availability').textContent===(!r.querySelector('input').checked?'DISABLED':r.classList.contains('ts-inert-row')?'NEEDS PROP':'AVAILABLE'))`);
