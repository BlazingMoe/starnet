...
(function (root, factory) {
  ...
  const CATALOG = [
    ...
    { id: 'gmail', name: 'Gmail', category: 'Productivity', authType: 'oauth', transport: 'http',
      ...
      staticOauth: GOOGLE_OAUTH(['https://www.googleapis.com/auth/gmail.readonly', 'https://www.googleapis.com/auth/gmail.compose', 'https://www.googleapis.com/auth/gmail.modify']),
      blurb: 'Search and read Gmail, manage reversible inbox/label state, create drafts, and send approved drafts. Sign in with Google to connect your account.' },
    { id: 'google-contacts', name: 'Google Contacts', category: 'Productivity', authType: 'oauth', transport: 'http',
      url: 'https://people.googleapis.com/v1', googleApi: true, official: false, homepage: 'https://contacts.google.com',
      aliases: ['google contacts', 'contacts', 'address book', 'google people', 'people api', 'gsuite', 'g suite', 'google workspace'],
      staticOauth: GOOGLE_OAUTH(['https://www.googleapis.com/auth/contacts.readonly']),
      blurb: 'Read and search your Google contacts so agents can resolve real recipient details without editing the address book.' },
    ...
    { id: 'google-calendar', name: 'Google Calendar', category: 'Productivity', authType: 'oauth', transport: 'http',
      ...
      staticOauth: GOOGLE_OAUTH(['https://www.googleapis.com/auth/calendar.calendarlist.readonly', 'https://www.googleapis.com/auth/calendar.events', 'https://www.googleapis.com/auth/calendar.events.freebusy']),
      blurb: 'Read availability and events, create or edit appointments, delete events, and respond to invitations. Sign in with Google to connect your account.' },
