...
(function () {
  ...
  const CRT_DEFAULTS = { scan: 0.38, pitch: 1, fade: 0.25, glow: 0.06, curve: 0.09, vig: 0.30, over: 1.20, dust: 0.5, aberr: 0.2, grain: 0.16, bloom: 0, emit: 0.6, mask: 0, bleed: 0, roll: 0 };
  ...
  const LIGHT_DEFAULTS = { ambient: 0.84, pool: 0.85, room: 0.46, corridor: 0.34, door: 0.4, floor: 0.24, crown: 0.45, pitch: 8, reach: 1.3, falloff: 0.85, cool: 0.9, warm: 0.16, spill: 0.7 };
