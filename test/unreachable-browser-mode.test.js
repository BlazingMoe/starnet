...
A.ok(/retrying every 5s \(attempt ' \+ attempts \+ '\)\. Your save is untouched\.' \+ \(core \? '' : ' ' \+ BROWSER_HINT\)/.test(body), 'every poll line repeats the hint in browser mode (a user arriving at attempt 12 still sees the exit)');
