...
A.eq((bake.match(/falloffStops\((?:gw|g), POOL_RGB, LIGHT\.floor\)/g) || []).length, 1,
  'corridor pools paint POOL_RGB along the shared falloff curve');
A.ok(bake.includes('verticalBeam(b, X + RW / 2, Y, RH, rad * 0.7, POOL_RGB, LIGHT.floor)'), 'room light extends the same warm falloff down the floor');
...
const lightControls = { ambient: '0.84', pool: '0.85', room: '0.46', corridor: '0.34', door: '0.4', floor: '0.24', crown: '0.45', pitch: '8', reach: '1.3', falloff: '0.85', cool: '0.9', warm: '0.16', spill: '0.7' };
