...
// Narrow chrome sheds secondary instruments; E-STOP remains reachable through SYSTEM.
...
has(/data-group="system"[\s\S]*id="estop-btn"[\s\S]*halt all runs · Alt\+H/,
  'SYSTEM exposes the emergency action and its global shortcut', fs.readFileSync(path.join(root, 'frontend/index.html'), 'utf8'));
